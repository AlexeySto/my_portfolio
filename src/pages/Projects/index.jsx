...
const Projects = () => {
  ...
  const rootWidth = document.getElementsByClassName('root')[0]?.offsetWidth || 0; // Используйте безопасный доступ к элементу
  ...
  return (
    <div className="container">
      ...
      <div className="projects-navigation">
        <div onClick={prevPage} disabled={currentIndex === 0}>
        ...
        <div onClick={nextPage} disabled={currentIndex === maxIndex - 1}>
          <svg className="slide__svg" viewBox="0 0 32 32">
